...
export class Backend implements backendInterface {
    ...
    async addMedia(arg0: ExternalBlob, arg1: string, arg2: string): Promise<MediaItem> {
        if (this.processError) {
            try {
...
async function from_candid_MediaItem_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _MediaItem): Promise<MediaItem> {
...
async function from_candid_vec_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_MediaItem>): Promise<Array<MediaItem>> {
    return await Promise.all(value.map(async (x)=>await from_candid_MediaItem_n9(_uploadFile, _downloadFile, x)));
}
